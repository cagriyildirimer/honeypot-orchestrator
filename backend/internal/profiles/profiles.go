...
var Profiles = map[string]*HoneypotProfile{
	...
	"windows_server": {
		...
		Services:    []string{"http_windows", "dns_windows", "netbios_windows", "ldap_windows", "ldaps_windows", "mssql_windows", "rdp_windows", "smb_windows", "llmnr_windows", "nbtnns_windows", "ssh_windows", "rpc_windows", "winrm_windows", "ftp_windows"},
		Telnet: TelnetProfile{
