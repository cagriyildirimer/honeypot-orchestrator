...
PROFILES: dict[str, HoneypotProfile] = {
    ...
    "windows_server": HoneypotProfile(
        ...
        services=("http_windows", "dns_windows", "netbios_windows", "ldap_windows", "ldaps_windows", "mssql_windows", "rdp_windows", "smb_windows", "llmnr_windows", "nbtnns_windows", "ssh_windows"),
        http=HTTPProfile(
